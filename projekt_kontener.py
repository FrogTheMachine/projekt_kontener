...
def setup_network(pid, cid):
    ...
    # Losowanie podsieci, żeby unikać konfliktów
...
def container_entry(cmd, rootfs, cid):
    # Czekanie, aż rodzic skonfiguruje sieć
    time.sleep(1)
...
def main():
    ...
    if pid1 == 0:
        ...
        # Robimy unshare (wewnątrz dziecka, nie rodzica)
        ...
        # Czekanie, żeby Dziecko 1 zdążyło zrobić unshare
        time.sleep(0.5)
